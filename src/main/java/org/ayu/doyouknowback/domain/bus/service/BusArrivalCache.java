...
public class BusArrivalCache {
     ...
     */
    private final ConcurrentHashMap<BusDirection, Entry> cache = new ConcurrentHashMap<>();
    /*
    새로운 버스 데이터를 캐시에 저장하거나 기존 데이터를 업데이트
    풀링을 통해 주기적으로 호출
     */
    public void put(BusDirection dir, BusResponseDTO dto) {
    ...
    */
    public Entry get(BusDirection dir) {
