...
//
//    @Mock
//    private NotificationRepository fcmRepository;
//
//    @Spy
...
//
//    private Notification testFcm;
//    private NotificationTokenRequestDTO testTokenRequestDTO;
//
//    @BeforeEach
//    void setUp() {
//        testFcm = Notification.builder()
//                .id(1L)
//                .token("ExponentPushToken[test-token-123]")
//                .platform("android")
//                .build();
//
//        testTokenRequestDTO = NotificationTokenRequestDTO.builder()
//                .token("ExponentPushToken[test-token-123]")
//                .platform("android")
//                .build();
//
...
//        verify(fcmRepository, times(1)).save(any(Notification.class));
//    }
//
//    @Test
...
//        // Then
//        verify(fcmRepository, times(1)).findByToken(testTokenRequestDTO.getToken());
//        verify(fcmRepository, never()).save(any(Notification.class));
//    }
//
//    @Test
...
//        // Given
//        List<Notification> fcmList = Arrays.asList(
//                Notification.builder().id(1L).token("ExponentPushToken[token1]").platform("android").build(),
//                Notification.builder().id(2L).token("ExponentPushToken[token2]").platform("ios").build());
//
...
//        // Given
//        List<Notification> fcmList = Arrays.asList(
//                Notification.builder().id(1L).token("ExponentPushToken[invalid-token]").platform("android").build());
//
//        when(fcmRepository.findAll()).thenReturn(fcmList);
//
...
//        List<Notification> fcmList = new java.util.ArrayList<>();
//        for (int i = 1; i <= 150; i++) {
//            fcmList.add(Notification.builder()
//                    .id((long) i)
...
//
//        // When
//        Optional<Notification> result = fcmRepository.findByToken(token);
//
//        // Then
